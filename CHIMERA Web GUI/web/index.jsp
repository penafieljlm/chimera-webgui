                ...
                <div class="column">
                    ...
                    <div class="ui form" id="trainingform" action="Training" method="post">
                        ...
                        <div class="ui fluid labeled action input">
                            ...
                            <input type="text" placeholder="Choose training file..." name="trainingfile">
                ...
                <div class="column">
                    ...
                    <div class="ui form" id="productionform" action="Production" method="post">
                        ...
                        <div class="ui fluid labeled action input">
                            ...
                            <input type="text" placeholder="Choose model file..." name="modelfile">
                            <div class="ui button">Browse</div>
                        </div>
                        </div>
                        
                        <div class="field" style="margin-top:20px;" >
                            <input type="text" placeholder="Specify syslog server address..." name="syslog">
                        </div>
